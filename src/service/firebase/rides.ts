...
// Ride
export const getSingleRideBasedOnRideId = async (
  rideId: string,
  setError: Function,
  setLoading: Function,
  setData: Function
 ...
 * @param order
 */
export const getRideCardsBasedOnRouteId = async (
  routeId: string,
  setError: Function,
  setLoading: Function,
  setData: Function,
...
export const delayMyRide = async (
  rideId: string,
...
export const requestToJoinTheRide = async (
  rideId: string,
  description: string,
  setStatus: Function,
  contact: Contact,
  ...
  try {
    await firestore
      .collection("user_requestsJunction")
      .doc(`${uid}_${rideId}`)
      .set({
        uid,
        photoURL,
 ...
 * @param setData
 */
export const getRideRequestsBasedOnRideId = async (
  rideId: string,
  setError: Function,
  setLoading: Function,
  setData: Function
  ...
  setLoading(true);
  try {
    const rideRequestDocs = await firestore
      .collection("user_requestsJunction")
      .where("rideId", "==", rideId)
      .get();
...
export const requestIdUpdateStatus = async (
  userId: string,
  rideId: string,
  status: "rejected" | "accepted",
  setLoading: Function,
  parent: "passenger" | "ride" | "ticket"
) => {
  try {
    setLoading(true);
